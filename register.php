    ...
    <div class="content" style="margin-top: 20px; margin-left: -40px;">
    	...
    	<form action="register.inc.php" autocomplete="off" method="POST">
		    ...
		    <div class="row justify-content-center align-items-baseline">
		      <div class="center one" style="padding-bottom:100px;">
		        <div class="form-row">
		        	<div class="form-group col-md-5">
			          <label for="cid">Student ID/ROLL NO</label>
		        ...
		        <div class="form-row">
		        	<div class="form-group col-md-5">
			          ...
			          <input type="password" class="form-control" class="password"  id="cid" name="pwd1" required>
                      <input type="checkbox" onclick="myFunction23()">Show Password					  
					  <script>
function myFunction23() {
  ...
  if (x.type === "password") {
    ...
    x.type = "password";
				...
				<div class="form-group"> <label for="cname">  Upload CV/REsume:    </label>
		        ...
		        <div class="form-row">
			        <div class="form-group col-md-5">
			          ...
			          <select class="form-control" name="secque" required>
			          	...
			          	<option>Which is your pet name?</option>
